...
const manifest = {
    id: 'org.myseedbox.sandbox.v3', version: '3.1.0', name: 'SandBox PRO Streamer',
...
setInterval(async () => {
    try {
        ...
        // 3. Emit to all authenticated sockets
...
server.listen(7000, () => console.log('WebSocket SandBox PRO v3.1.0 Ready.'));
