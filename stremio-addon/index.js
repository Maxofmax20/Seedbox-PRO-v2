...
const manifest = {
    id: 'org.myseedbox.sandbox.v3', version: '3.3.0', name: 'SandBox ULTIMATE Node',
...
server.listen(7000, () => console.log('SandBox ULTIMATE v3.3.0 Ready.'));
